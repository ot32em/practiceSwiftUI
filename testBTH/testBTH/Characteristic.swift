...
struct Service {
    struct HeartRate {
        static let utid: String = "org.bluetooth.service.heart_rate"
        static let uuid = CBUUID(string: "0x180D")
    }
}

struct Characteristic {
    struct HeartRateMeasurement {
        static let utid: String = "org.bluetooth.characteristic.heart_rate_measurement"
        static let uuid = CBUUID(string: "0x2A37")
    ...
    struct HeartRateBodySensorLocation {
        static let utid: String = "org.bluetooth.characteristic.body_sensor_location"
        static let uuid = CBUUID(string: "0x2A38")
